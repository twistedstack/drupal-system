...
/**
 * Sets the moderation state to Archived.
 *
 * @Action(
 *   id = "set_moderation_state_archived",
 *   label = @Translation("Set Moderation State to Archived"),
 *   type = "node"
 * )
 */
class SetModerationStateArchived extends ActionBase {
