...
namespace Drupal\add_content_dropdown_block\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "addcontentdropdownblock",
 *   admin_label = @Translation("Addcontentdropdown"),
 *   category = @Translation("Custom")
 * )
 */
class AddContentDropdownBlock extends BlockBase implements ContainerFactoryPluginInterface {
